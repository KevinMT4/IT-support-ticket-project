...
const TicketDetail = () => {
  ...
  const handleStatusChange = async (newStatus) => {
    try {
      setUpdating(true);
      const updatedTicket = await apiClient.updateTicketStatus(id, newStatus);
      ...
      <div className="ticket-detail-container">
          ...
          <div className="header-content">
            <div className="header-left">
              ...
              <div className="ticket-badges-detail">
                <span className={`badge priority-badge ${getPriorityClass(ticket.prioridad)}`}>
                  {ticket.prioridad_display}
                </span>
                <span className={`badge status-badge ${getStatusClass(ticket.estado)}`}>
        ...
        <div className="ticket-detail-content">
          <div className="ticket-main">
            ...
            <div className="ticket-section">
              <h3>Descripción</h3>
              <div className="ticket-description">{ticket.contenido}</div>
            </div>
              ...
              <div className="ticket-section">
                ...
                <div className="status-buttons">
                  ...
                  <button
                    ...
                    disabled={updating || ticket.estado === 'en_proceso'}
                  >
                    En Proceso
                  </button>
                  <button
          ...
          <div className="ticket-sidebar">
            <div className="info-card">
              ...
              <div className="info-item">
                ...
                <span className="info-value">{ticket.departamento_nombre}</span>
              </div>
              {ticket.motivo_nombre && (
                <div className="info-item">
                  <span className="info-label">Motivo</span>
                  <span className="info-value">{ticket.motivo_nombre}</span>
                </div>
              )}
              <div className="info-item">
                <span className="info-label">Prioridad</span>
                <span className="info-value">{ticket.prioridad_display}</span>
              </div>
              <div className="info-item">
                <span className="info-label">Estado</span>
                <span className="info-value">{ticket.estado_display}</span>
              </div>
              <div className="info-item">
                <span className="info-label">Creado</span>
                <span className="info-value">{formatDate(ticket.fecha_creacion)}</span>
              </div>
              {ticket.fecha_cierre && (
                <div className="info-item">
                  <span className="info-label">Cerrado</span>
                  <span className="info-value">{formatDate(ticket.fecha_cierre)}</span>
                </div>
              )}
            </div>
          </div>
