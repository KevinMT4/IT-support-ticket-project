...
ALLOWED_HOSTS = os.getenv('DJANGO_ALLOWED_HOSTS', 'localhost,127.0.0.1,localhost:8000,127.0.0.1:8000').split(',')
...
# path to translation files (if using django's internationalization machinery)
...
# Email Configuration
# Usar OAuth2 backend personalizado para Gmail
EMAIL_BACKEND = 'ticket_system.oauth_email_backend.OAuth2EmailBackend'
